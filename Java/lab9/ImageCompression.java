...
System.out.println("GDZIE JA JESTEM?!!!!!!!!!!\nSuma to " + suma + ", a kolor biezacy to " + wsk.x);	
	if(wsk.x==kolorPedzla) // czy poprzedni kolor jest taki sam jak aktualny
		...
		System.out.println("Poprzedni kolor jest taki sam");	
...
/*	else if(it.hasPrevious())
		{
		System.out.println("MAM POPRZEDNIKA");
		System.out.println("Pole biezace ma rozmiar " + wsk.y);
		if(wsk.y==1) {System.out.println("To pole ma tylkoe 1 ");}
		}*/
...
//obrazek.setPenBrightness(5);
System.out.println("DRUGI PIXEL");
obrazek.setPixel(1,2);

//obrazek.setPenBrightness(7);
System.out.println("OSTATNI PIXEL");
