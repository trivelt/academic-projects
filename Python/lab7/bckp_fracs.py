...
#	self.assertEqual(cmp_frac([1, 2], [7, 14]), 0)
	...
	self.assertTrue(Frac(1, 3).is_positive(), True)
#	self.assertTrue(Frac(-4, 7).is_positive(), False)
#	self.assertTrue(Frac(2,-2).is_positive(), False)
	...
	#self.assertRaises(ZeroDivisionError, Frac.frac2float(Frac(5, 0)))
